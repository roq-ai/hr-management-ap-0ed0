...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        ...
        order: params.order,
        searchTermKeys: ['description.contains', 'images.contains', 'name.contains', 'managemnet.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'images', header: 'Images', accessorKey: 'images' },
    { id: 'name', header: 'Name', accessorKey: 'name' },
    { id: 'tenant_id', header: 'Tenant Id', accessorKey: 'tenant_id' },
    { id: 'managemnet', header: 'Managemnet', accessorKey: 'managemnet' },
