  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unleash your company's potential with HR Management Application - Your one-stop solution for efficient and streamlined human resources operations."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unleash your company's potential with HR Management Application - Your one-stop solution for efficient and streamlined human resources operations.`}
            </Text>
            <Box
